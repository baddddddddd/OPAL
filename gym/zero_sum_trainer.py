...
from agents import ZeroSumAgent
...
class ZeroSumTrainer:
    def __init__(self, model: nn.Module, game: Game, parallelized=False):
        ...
        self.game = game
        self.max_player = ZeroSumAgent(self.model, self.device, self.game)
        self.min_player = ZeroSumAgent(self.model, self.device, self.game)
